...
int main()
{
    ...
    data[0].id=1;
    strcpy(data[0].name,"birat vatij");
    ...
    data[1].id=10;
    strcpy(data[1].name,"birat poudel");
...
//    printf("\tID Name\t\t Address \tFaculty\t MM\t DD\t YY \n");
    ...
    data[2].id=2;
    strcpy(data[2].name,"birat paudel");
...
//    printf("\tID Name\t\t Address \tFaculty\t MM\t DD\t YY \n");
    ...
    data[3].id=3;
    strcpy(data[3].name,"birat vatij");
...
//    printf("\tID Name\t\t Address \tFaculty\t MM\t DD\t YY \n");
    ...
    data[4].id=4;
    strcpy(data[4].name,"birat vatij");
